...
public class Marcas extends javax.swing.JFrame {
     ...
     * Creates new form
     */
    public Marcas(PrProducto prProducto) {
    ...
    private void botonAceptar(){
       try {
            ...
            String nombreMarca = jTextField1.getText().trim();
            ...
            String idMarca = daoMarca.insertarMarca(nombreMarca);

            // Verificar si la marca fue insertada correctamente
            if (idMarca != null) {
                JOptionPane.showMessageDialog(this, "Marca insertada exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            
                 // Actualizar el combo box de marcas en la pantalla de productos
                prProducto.cargarMarcas();
            } else {
                JOptionPane.showMessageDialog(this, "No se pudo insertar la marca.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Error al agregar la marca: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        } finally {
           dispose();
       }
...
private void configComponents(){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Marcas(prProducto).setVisible(true));
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Marcas(prProducto).setVisible(true);  
            }
        });
    }
